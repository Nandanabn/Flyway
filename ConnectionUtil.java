...
if(rs.next())  {
String[]  flight=new  String[3]; flight[0]=rs.getString("name"); flight[1]=rs.getString("timef"); flight[2]=rs.getString("priceice"); flights.add(flight);
return  flights;
}
...
return  true;
	...
	//String  sql="INSERT  INTO  flights  
		('name','from','to','date','time','price') values('"+flight.get("name")+"','"+flight.get("from")+"','"+flight.get("to")+"','"
				...
				`flyaway`.`flights`	(`name`,	`fromf`,	`tof`,
